...
case class TemporalColumnHelper(id: String, attrId: Int, value: collection.IndexedSeq[(Long,ValueLineageWithHashMap)]) extends JsonWritable[TemporalColumnHelper] {
