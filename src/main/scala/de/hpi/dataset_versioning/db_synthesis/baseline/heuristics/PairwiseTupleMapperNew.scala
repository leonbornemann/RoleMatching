...
import de.hpi.dataset_versioning.db_synthesis.baseline.LayeredTupleIndex
import de.hpi.dataset_versioning.db_synthesis.sketches.TemporalFieldTrait

import scala.collection.mutable

class PairwiseTupleMapperNew[A](tableA: TemporalDatabaseTableTrait[A], tableB: TemporalDatabaseTableTrait[A], index: LayeredTupleIndex[A], mapping: collection.Map[Set[AttributeLineage], Set[AttributeLineage]]) {
...
object PairwiseTupleMapperNew extends StrictLogging{
