...
object GeneralEdgeGraphToSlimGraph extends App with StrictLogging {
  ...
  val scoringFunction = new EvidenceBasedWeighingScore[Any](TIMESTAMP_RESOLUTION_IN_DAYS, trainTimeEnd, GLOBAL_CONFIG.nonInformativeValues, true, Some(tfIDF), None, Some(ISFWeightingVariant.DVD))
