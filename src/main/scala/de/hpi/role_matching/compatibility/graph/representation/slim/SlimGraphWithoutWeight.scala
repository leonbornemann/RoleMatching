...
import de.hpi.role_matching.compatibility.graph.representation.simple.{GeneralEdge, GeneralEdgeIterator}
...
object SlimGraphWithoutWeight extends JsonReadable[SlimGraphWithoutWeight] with StrictLogging {
  ...
  def fromGeneralEdgeIterator(edges: GeneralEdge.JsonObjectPerLineFileIterator,
