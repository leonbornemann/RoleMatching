...
import de.hpi.socrata.tfmp_input.table.nonSketch.{ChangePoint, CommonPointOfInterestIterator, ValueTransition}
import de.hpi.role_matching.scoring.MultipleEventWeightScoreComputer.{getCountPrev, transitionIsNonInformative}
