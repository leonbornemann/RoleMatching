...
import de.hpi.socrata.io.Socrata_Synthesis_IOService.{ASSOCIATION_SCHEMA_DIR, createParentDirs}
import de.hpi.socrata.metadata.custom.schemaHistory.AttributeLineageWithHashMap
import de.hpi.socrata.tfmp_input.association
import de.hpi.socrata.tfmp_input.association.AssociationSchema.getAssociationSchemaFile
...
class AssociationSchema(val id:AssociationIdentifier,
  ...
  def writeToStandardFile() = {
    ...
    val helper = association.AssociationSchemaHelper(id,
      surrogateKey,
