...
import de.hpi.socrata.tfmp_input.table.sketch.FactLineageSketch.WILDCARD
...
object FactLineageSketch {
  ...
  val timestampToByteRepresentation = {
    (Socrata_IOService.STANDARD_TIME_FRAME_START.toEpochDay to Socrata_IOService.STANDARD_TIME_FRAME_END.toEpochDay)
      .zipWithIndex
