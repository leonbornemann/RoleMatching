package de.hpi.tfm.data.socrata.change.temporal_tables
...
import de.hpi.tfm.data.socrata.change.temporal_tables.tuple.TemporalRow
import de.hpi.tfm.data.tfmp_input.association.AssociationIdentifier
import de.hpi.tfm.data.tfmp_input.table.nonSketch.FactLineage
import de.hpi.tfm.data.tfmp_input.{BinaryReadable, BinarySerializable}
