...
case class WikipediaEdgeStatRow(e: WikipediaInfoboxValueHistoryMatch,TIMESTAMP_RESOLUTION_IN_DAYS:Int,trainGraphConfig:GraphConfig) {
  ...
  def toGeneralStatRow(nonInformativeValues:Set[Any],
                        ...
                        lineageCount:Int) =
    GeneralEdgeStatRow(TIMESTAMP_RESOLUTION_IN_DAYS,trainGraphConfig,v1String,v2String,v1.lineage.toFactLineage,v2.lineage.toFactLineage,nonInformativeValues,transitionHistogramForTFIDF,lineageCount)
