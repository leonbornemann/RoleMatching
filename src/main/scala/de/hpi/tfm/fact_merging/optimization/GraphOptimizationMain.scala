...
import de.hpi.tfm.evaluation.data.{GeneralEdge, SlimGraphOld}
...
//  val slimGraph = SlimGraphOld.fromIdentifiedEdges(edges,distanceMetric) //or load this directly
//  slimGraph.toJsonFile(slimGraphFile)
//  edges=null
//  logger.debug("Finished transformation to slim graph")
//  val optimizer = new GreedyEdgeBasedOptimizer(slimGraph.transformToOptimizationGraph, resultFile) //TODO: get threshold somewere!
