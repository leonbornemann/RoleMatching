...
import de.hpi.role_matching.blocking.cbrb.role_tree.RoleTreeExecutionConfig
import de.hpi.role_matching.data.UpdateChangeCounter
...
object GLOBAL_CONFIG extends StrictLogging {
  ...
  var INDEXING_CONFIG = RoleTreeExecutionConfig(0.9, 0.9, 50)
