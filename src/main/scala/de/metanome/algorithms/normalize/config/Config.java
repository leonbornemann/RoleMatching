...
public class Config {
	...
	/*public enum Dataset {
		...
		TPCH, AMALGAM, MUSICBRAINZ, TEST,SOCRATA
	}*/
	
	//private Dataset defaultDataset = Dataset.SOCRATA;//NCVOTER_1K;//MUSICBRAINZ;//Dataset.HORSE;//TPCH;//AMALGAM;//TEST;//HEPATITIS;
...
//	public String inputFolderPath = "." + File.separator + "data" + File.separator;
	...
	/*public void setDataset(Config.Dataset dataset) {
		...
		switch (dataset) {
			case SOCRATA:
				this.inputDatasetName = "2019-12-24_abk6-gwwr";
